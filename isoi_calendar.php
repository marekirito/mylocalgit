...
<script>
    ...
    deleteEvent(eventId); // 클릭한 이벤트의 ID를 deleteEvent 함수에 전달하여 삭제
}, 
...
function openEventModal(clickedDate) {
    ...
    $('#start_date').val(clickedDate.format("YYYY-MM-DDTHH:MM:SSZ"));
    $('#end_date').val(clickedDate.format("YYYY-MM-DDTHH:MM:SSZ"));
}
